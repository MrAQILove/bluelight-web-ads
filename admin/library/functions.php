...
function buildCategoryOptions($catId = 0)
{
	...
	/*
	$sql = "SELECT cat_id, cat_parent_id, cat_name, cat_year_created, cat_active
			FROM tbl_category
			WHERE cat_year_created = '$current_year'
			AND cat_active ='1'
			ORDER BY cat_id";
	*/
	...
	$result = dbQuery($sql) or die('Cannot get Web Advert. ' . mysql_error());
