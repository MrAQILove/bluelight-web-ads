...
<body lang="en">
<center><h1 class="title">Multiple Drag and Drop File Upload - Skyscraper Banner</h1></center>
<div id="dragAndDropFiles" class="uploadArea">
	<h1>Drop Artwork Here</h1>
</div>
<form name="demoFiler" id="demoFiler" enctype="multipart/form-data">
<input type="hidden" name="cat_parent_id" id="input_1" value="3" />
<!--
<input type="hidden" name="catId"	id="input_2" value="11" />
<input type="hidden" name="state_id" id="input_3" value="2" />
<input type="hidden" name="location_id" id="input_4" value="21" />
<input type="hidden" name="start_date" id="input_5" value="2013-10-01" />
<input type="hidden" name="end_date" id="input_6" value="2013-12-31" />
-->
