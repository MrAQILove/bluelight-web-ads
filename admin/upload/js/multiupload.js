function multiUploader(config){
	...
	multiUploader.prototype._uploader = function(file,f){
		...
		{	
			...
			data.append('ad_type',q0);
			data.append('cat_parent_id',q1);
			data.append('catId',q2);
			data.append('state_id',q3);
			data.append('location_id',q4);
			data.append('start_date',q5);
			data.append('end_date',q6);
			...
			$.ajax({
				...
				success:function(rponse)
				{
					...
					//if(rponse.status == 'success'){ //redirect...
                    //    alert("http://www.bluelight.com.au/php/web-ads/admin/product/index.php?catId="+q2);
					//} 
				}
			});
		} 
